...
Path1 = '/Users/manojgulati/Documents/Algo_Testing_Data/EMI_MSMT_12_NOV_2015/';
Path2 = 'BGN_OC1/';
Path3 = 'BGN1';
Path4 = 'FFT/';
...
ConvertPlot4Publication(strcat(Path1,Path2,Path4,Path3,'_'),'height',4, 'width',6,'fontsize', 10, 'fontname', 'Times New Roman', 'samexaxes', 'on','linewidth',0.5,'pdf','off','eps','off','psfrag','off','fig','off');
