...
Path1 = '/Users/manojgulati/Documents/Algo_Testing_Data/30 March 2015/PRT3 Arti/';
Path2 = 'PRT3_';
...
for i = (offset+1):(No_of_traces*index)
    ...
    Y1(:,(i-offset))  = fft(y1(:,(i-offset)))/L;
    % Computing spectrum for Common Mode EMI 
    Y2(:,(i-offset))  = fft(y2(:,(i-offset)))/L;
    % Computing magnitude of Vdm and Vcm for length L/2
    ampY_1(:,(i-offset)) = 2*abs(Y1(1:L/2+1,(i-offset)));
